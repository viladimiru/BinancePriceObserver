...
export default {
	...
	tradeCreated:
		'<b>Сделка успешно добавлена в список</b>\n\nТеперь вы сможете следить за динамикой в котировках',
	addTrade: 'Добавить сделку ' + emoji.dollar,
	removeTrade: 'Удалить сделку ' + emoji.trash,
	shoulder: 'Размер плеча',
	feedback:
		'Вы можете оценить данного бота, оставить запрос на расширение функционала или пожаловаться на недоработки, мы обязательно примем всё во внимание',
	...
	miss: 'Пропустить ⤵️',
	stopLossIfExist:
		'Значение Stop loss (Если есть). Мы отправим уведомление при достижении значения',
	takeProfitIfExist:
		'Значение Take profit (Если есть). Мы отправим уведомление при достижении значения',
	yes: 'Да',
