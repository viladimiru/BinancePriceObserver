...
export async function updateTempPairByChatId(data, chatId) {
...
export async function setTempPairByChatId(data, chatId) {
...
export async function deleteTempPairByChatId(chatId) {
...
export async function getTempPairByChatId(chatId) {
	return await TEMP_PAIR.findOne({
		where: {
			chatId: chatId,
		},
...
export async function removePair(symbol, chatId, type, price) {
...
export async function getChatPairs(chatId) {
	const res = await PAIR.findAll({
		include: {
			model: TRIGGER,
			as: 'triggers',
...
export async function isChatPairExists(chatId, symbol, type, price) {
	try {
